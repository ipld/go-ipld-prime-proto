...
func (_RawNode__Assembler) BeginMap(sizeHint int64) (ipld.MapAssembler, error) {
	return mixins.BytesAssembler{"dagpb.RawNode"}.BeginMap(0)
}
func (_RawNode__Assembler) BeginList(sizeHint int64) (ipld.ListAssembler, error) {
...
func (_RawNode__Assembler) AssignInt(int64) error {
